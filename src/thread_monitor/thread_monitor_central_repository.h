...
public:
  ...
  static inline constexpr auto kStaleThreadThreshold =
...
private:
  ...
  static ThreadMonitorCentralRepository *
      _staticInstance(bool withMonitorThread);

  std::atomic<std::chrono::system_clock::duration> _threadTimeout =
      std::chrono::duration_cast<std::chrono::system_clock::duration>(
          kDefaultThreadTimeout);
  ...
  std::chrono::system_clock::time_point _lastTimeOfFaultAction =
